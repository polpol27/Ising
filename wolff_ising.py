    ...
    config: array
        ...
        tipo: str
            Determina el tipo de red: 
                ...
                Red Small World 1D: "sw1d"
                Red Small World 2D: "sw2"
        params: array
...
##Small World -- tipo = "sw1d" (1D) o "sw2" (2D)
k=4
p=0
params_sw=[k,p]
...
lim_inf=3#float(input("Limite inferior? ")) 
lim_sup=5#float(input("Limite superior? ")) 
cant=101#int(input("Cantidad? "))           
...
#Guardar parámetros en la carpeta
